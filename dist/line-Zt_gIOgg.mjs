...
import { a0 as v } from "./index-BXM0AnV6.mjs";
function w(t) {
  return t[0];
}
function b(t) {
...
function P(t, u) {
  ...
  function e(n) {
    var f, g = (n = h(n)).length, a, c = !1, p;
    for (i == null && (r = l(p = m())), f = 0; f <= g; ++f)
      !(f < g && s(a = n[f], f, n)) === c && ((c = !c) ? r.lineStart() : r.lineEnd()), c && r.point(+t(a, f, n), +u(a, f, n));
...
//# sourceMappingURL=line-Zt_gIOgg.mjs.map
