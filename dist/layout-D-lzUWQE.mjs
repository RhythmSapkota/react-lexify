import { a as mn, b as $n, c as L, k as Wn, d as zn, e as Xn, g as O, j as bn, l as gn, m as xn, t as Un, n as En, o as Hn, p as jn, G as x, f as s, h as w, i as g, q as M, v as y, r as G } from "./graph-BCqGxtUq.mjs";
import { aN as Jn, aO as X, aP as on } from "./index-ErFAu9zp.mjs";
import { ar as Kn, as as Zn, at as kn, au as S, av as yn, aw as Qn, ax as Nn, ay as j, az as ne, aA as ee, aB as J, aC as re, aD as Ln, aE as ie, aF as te, aG as U } from "./index-BXM0AnV6.mjs";
var ae = 1 / 0, oe = 17976931348623157e292;
function F(n) {
  if (!n)
    return n === 0 ? n : 0;
  if (n = Jn(n), n === ae || n === -1 / 0) {
    var e = n < 0 ? -1 : 1;
    return e * oe;
  }
  return n === n ? n : 0;
...
var _n = Object.prototype, he = _n.hasOwnProperty, le = kn(function(n, e) {
  n = Object(n);
  var r = -1, i = e.length, t = i > 2 ? e[2] : void 0;
  for (t && S(e[0], e[1], t) && (i = 1); ++r < i; )
    for (var o = e[r], a = yn(o), u = -1, d = a.length; ++u < d; ) {
      var f = a[u], c = n[f];
      (c === void 0 || Qn(c, _n[f]) && !he.call(n, f)) && (n[f] = o[f]);
    }
  return n;
});
function A(n) {
...
function we(n, e, r) {
  ...
  if (!i)
    return -1;
  var t = r == null ? 0 : ue(r);
  return t < 0 && (t = pe(i + t, 0)), zn(n, L(e), t);
}
var K = ve(we);
function Cn(n, e) {
  var r = -1, i = Nn(n) ? Array(n.length) : [];
  return Xn(n, function(t, o, a) {
    i[++r] = e(t, o, a);
  }), i;
}
function m(n, e) {
...
function V(n, e) {
  var r = {};
  return e = L(e), gn(n, function(i, t, o) {
    ee(r, t, e(i, t, o));
  }), r;
}
function Z(n, e, r) {
  for (var i = -1, t = n.length; ++i < t; ) {
    var o = n[i], a = e(o);
    if (a != null && (u === void 0 ? a === a && !X(a) : r(a, u)))
      var u = a, d = o;
  }
  return d;
}
function E(n) {
  return n && n.length ? Z(n, J, ge) : void 0;
}
function I(n) {
  return n && n.length ? Z(n, J, Rn) : void 0;
}
function Q(n, e) {
  return n && n.length ? Z(n, L(e), Rn) : void 0;
}
function xe(n, e, r, i) {
  if (!on(n))
    return n;
  ...
  for (var t = -1, o = e.length, a = o - 1, u = n; u != null && ++t < o; ) {
    ...
    if (t != a) {
      var c = u[d];
      f = void 0, f === void 0 && (f = on(c) ? c : re(e[t + 1]) ? [] : {});
    }
    Ln(u, d, f), u = u[d];
  }
  return n;
...
function ye(n, e) {
  if (n !== e) {
    var r = n !== void 0, i = n === null, t = n === n, o = X(n), a = e !== void 0, u = e === null, d = e === e, f = X(e);
...
function Le(n, e, r) {
  ...
  var i = -1;
  e = O(e, ie(L));
  var t = Cn(n, function(o, a, u) {
    var d = O(e, function(f) {
      return f(o);
    });
    return { criteria: d, index: ++i, value: o };
  });
  return ke(t, function(o, a) {
    return Ne(o, a, r);
  });
}
function _e(n, e) {
  return Ee(n, e, function(r, i) {
    return Hn(n, i);
  });
}
var B = de(function(n, e) {
  return n == null ? {} : _e(n, e);
}), Ce = Math.ceil, Re = Math.max;
function Ie(n, e, r, i) {
  for (var t = -1, o = Re(Ce((e - n) / (r || 1)), 0), a = Array(o); o--; )
    a[++t] = n, n += r;
  return a;
}
function Te(n) {
  return function(e, r, i) {
    return i && typeof i != "number" && S(e, r, i) && (r = i = void 0), e = F(e), r === void 0 ? (r = e, e = 0) : r = F(r), i = i === void 0 ? e < r ? 1 : -1 : F(i), Ie(e, r, i);
  };
}
var N = Te(), P = kn(function(n, e) {
  if (n == null)
    return [];
  var r = e.length;
  return r > 1 && S(n, e[0], e[1]) ? e = [] : r > 2 && S(e[0], e[1], e[2]) && (e = [e[0]]), Le(n, mn(e), []);
}), Me = 0;
function nn(n) {
  var e = ++Me;
  return jn(n) + e;
...
class Fe {
  ...
  enqueue(e) {
    ...
    e._prev && e._next && un(e), e._next = r._next, r._next._prev = e, r._next = e, e._prev = r;
  }
  toString() {
    for (var e = [], r = this._sentinel, i = r._prev; i !== r; )
      e.push(JSON.stringify(i, Se)), i = i._prev;
    return "[" + e.join(", ") + "]";
  }
}
function un(n) {
...
function Be(n, e) {
  if (n.nodeCount() <= 1)
    return [];
  var r = Ve(n, e || Ae), i = Ge(r.graph, r.buckets, r.zeroIdx);
  return _(
    m(i, function(t) {
...
function Ye(n) {
  var e = n.graph().acyclicer === "greedy" ? Be(n, r(n)) : De(n);
  s(e, function(i) {
    var t = n.edge(i);
    n.removeEdge(i), t.forwardName = i.name, t.reversed = !0, n.setEdge(i.w, i.v, t, nn("rev"));
  });
  function r(i) {
    return function(t) {
...
function fn(n, e, r, i) {
  ...
  return arguments.length >= 4 && (t.rank = r, t.order = i), C(n, "border", t, e);
}
function Tn(n) {
  return E(
  ...
  function e(r) {
    ...
    if (i.length && s(i, e), w(t, "minRank")) {
      ...
      for (var o = t.minRank, a = t.maxRank + 1; o < a; ++o)
        sn(n, "borderLeft", "_bl", r, t, o), sn(n, "borderRight", "_br", r, t, o);
    }
  }
  s(n.children(), e);
}
function sn(n, e, r, i, t, o) {
  var a = { width: 0, height: 0, rank: o, borderType: e }, u = t[e][o - 1], d = C(n, "border", a, r);
...
function Je(n) {
  var e = n.graph().rankdir.toLowerCase();
  (e === "bt" || e === "rl") && Ke(n), (e === "lr" || e === "rl") && (Ze(n), Mn(n));
}
function Mn(n) {
  ...
  if (o !== i + 1) {
    ...
    for (h = 0, ++i; i < o; ++h, ++i)
      u.points = [], c = {
        ...
        edgeObj: e,
        rank: i
      }, f = C(n, "edge", c, "_d"), i === d && (c.width = u.width, c.height = u.height, c.dummy = "edge-label", c.labelpos = u.labelpos), n.setEdge(r, f, { weight: u.weight }, a), h === 0 && n.graph().dummyChains.push(f), r = f;
...
function Pn(n) {
  ...
  e.setNode(r, {});
  for (var t, o; rr(e, n) < i; )
    t = ir(e, n), o = e.hasNode(t.v) ? T(n, t) : -T(n, t), tr(e, n, o);
  return e;
}
function rr(n, e) {
  function r(i) {
    s(e.nodeEdges(i), function(t) {
      ...
      !n.hasNode(a) && !T(e, t) && (n.setNode(a, {}), n.setEdge(i, a, {}), r(a));
    });
  }
...
function Gn(n, e, r) {
  ...
  var f = M(e.edges(), function(c) {
    return d === hn(n, n.node(c.v), u) && d !== hn(n, n.node(c.w), u);
  });
...
function Vn(n, e, r, i) {
  var t = r.v, o = r.w;
  n.removeEdge(t, o), n.setEdge(i.v, i.w, {}), tn(n), rn(n, e), fr(n, e);
}
function fr(n, e) {
  var r = K(n.nodes(), function(t) {
...
function vr(n) {
  var e = C(n, "root", {}, "_root"), r = pr(n), i = E(y(r)) - 1, t = 2 * i + 1;
...
function Yn(n, e, r, i, t, o, a) {
  ...
  var d = fn(n, "_bt"), f = fn(n, "_bb"), c = n.node(a);
  n.setParent(d, a), c.borderTop = d, n.setParent(f, a), c.borderBottom = f, s(u, function(h) {
    Yn(n, e, r, i, t, o, h);
    var l = n.node(h), v = l.borderTop ? l.borderTop : h, p = l.borderBottom ? l.borderBottom : h, b = l.borderTop ? i : 2 * i, R = v !== p ? 1 : t - o[a] + 1;
    n.setEdge(d, v, {
      weight: b,
      minlen: R,
      nestingEdge: !0
...
function gr(n, e, r) {
  var i = xr(n), t = new x({ compound: !0 }).setGraph({ root: i }).setDefaultNodeLabel(function(o) {
    return n.node(o);
  });
...
function _r(n) {
  ...
  function r(o) {
    return function(a) {
      a.merged || (g(a.barycenter) || g(o.barycenter) || a.barycenter >= o.barycenter) && Cr(o, a);
    };
  }
  function i(o) {
    return function(a) {
...
function Rr(n, e) {
  var r = Xe(n, function(c) {
    return w(c, "barycenter");
  }), i = r.lhs, t = P(r.rhs, function(c) {
    return -c.i;
  }), o = [], a = 0, u = 0, d = 0;
  i.sort(Ir(!!e)), d = vn(o, t, d), s(i, function(c) {
    d += c.vs.length, o.push(c.vs), a += c.barycenter * c.weight, u += c.weight, d = vn(o, t, d);
  });
  var f = { vs: _(o) };
  return u && (f.barycenter = a / u, f.weight = u), f;
}
function vn(n, e, r) {
  for (var i; e.length && (i = A(e)).i <= r; )
    e.pop(), n.push(i.vs), r++;
  return r;
}
function Ir(n) {
...
function Pr(n) {
  var e = Tn(n), r = pn(n, N(1, e + 1), "inEdges"), i = pn(n, N(e - 1, -1, -1), "outEdges"), t = yr(n);
  wn(n, t);
  for (var o = Number.POSITIVE_INFINITY, a, u = 0, d = 0; d < 4; ++u, ++d) {
    Or(u % 2 ? r : i, u % 4 >= 2), t = Y(n);
    var f = Er(n, t);
    f < o && (d = 0, a = ce(t), o = f);
  }
  wn(n, a);
...
function Or(n, e) {
  var r = new x();
  s(n, function(i) {
    var t = i.graph().root, o = Dn(i, t, r, e);
    s(o.vs, function(a, u) {
      i.node(a).order = u;
    }), br(i, r, o.vs);
  });
...
function Fr(n) {
  ...
  s(n.graph().dummyChains, function(r) {
    for (var i = n.node(r), t = i.edgeObj, o = Sr(n, e, t.v, t.w), a = o.path, u = o.lca, d = 0, f = a[d], c = !0; r !== t.w; ) {
      if (i = n.node(r), c) {
...
function Br(n, e) {
  var r = {};
  function i(t, o) {
    var a = 0, u = 0, d = t.length, f = A(o);
    return s(o, function(c, h) {
      var l = Vr(n, c), v = l ? n.node(l).order : d;
      (l || c === f) && (s(o.slice(u, h + 1), function(p) {
        s(n.predecessors(p), function(b) {
          var R = n.node(b), an = R.order;
          (an < a || v < an) && !(R.dummy && n.node(p).dummy) && qn(r, b, p);
        });
      }), u = h + 1, a = v);
    }), o;
  }
    ...
    s(u, function(f) {
      ...
      if (c.length) {
        ...
        for (var h = (c.length - 1) / 2, l = Math.floor(h), v = Math.ceil(h); l <= v; ++l) {
          var p = c[l];
          o[f] === f && d < a[p] && !Yr(r, f, p) && (o[p] = f, o[f] = t[f] = t[p], d = a[p]);
        }
      }
    });
  }), { root: t, align: o };
}
function qr(n, e, r, i, t) {
  var o = {}, a = $r(n, e, r, t), u = t ? "borderLeft" : "borderRight";
  function d(h, l) {
...
function $r(n, e, r, i) {
  var t = new x(), o = n.graph(), a = Hr(o.nodesep, o.edgesep, i);
  return s(e, function(u) {
    var d;
    s(u, function(f) {
      var c = r[f];
...
function zr(n, e) {
  var r = y(e), i = I(r), t = E(r);
  s(["u", "d"], function(o) {
    s(["l", "r"], function(a) {
      var u = o + a, d = n[u], f;
      if (d !== e) {
        var c = y(d);
        f = a === "l" ? i - I(c) : t - E(c), f && (n[u] = V(d, function(h) {
          return h + f;
        }));
      }
    });
...
function Ur(n) {
  var e = Y(n), r = U(Br(n, e), Gr(n, e)), i = {}, t;
  s(["u", "d"], function(a) {
    t = a === "u" ? e : y(e).reverse(), s(["l", "r"], function(u) {
      u === "r" && (t = m(t, function(h) {
        return y(h).reverse();
      }));
      var d = (a === "u" ? n.predecessors : n.successors).bind(n), f = Dr(n, t, r, d), c = qr(n, t, f.root, f.align, u === "r");
      u === "r" && (c = V(c, function(h) {
        return -h;
      })), i[a + u] = c;
    });
  });
  var o = Wr(n, i);
  return zr(i, o), Xr(i, n.graph().align);
}
function Hr(n, e, r) {
...
function Jr(n) {
  n = In(n), Kr(n), be(Ur(n), function(e, r) {
    n.node(r).x = e;
  });
}
function Kr(n) {
  var e = Y(n), r = n.graph().ranksep, i = 0;
  s(e, function(t) {
    var o = E(
      m(t, function(a) {
...
var ni = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], ei = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, ri = ["acyclicer", "ranker", "rankdir", "align"], ii = ["width", "height"], ti = { width: 0, height: 0 }, ai = ["minlen", "weight", "width", "height", "labeloffset"], oi = {
  minlen: 1,
  weight: 1,
  width: 0,
  height: 0,
...
function di(n) {
  var e = new x({ multigraph: !0, compound: !0 }), r = z(n.graph());
  return e.setGraph(
    U({}, ei, W(r, ni), B(r, ri))
  ), s(n.nodes(), function(i) {
    var t = z(n.node(i));
    e.setNode(i, le(W(t, ii), ti)), e.setParent(i, n.parent(i));
...
function ci(n) {
  ...
  s(n.nodes(), function(r) {
    var i = n.node(r);
    i.borderTop && (i.minRank = n.node(i.borderTop).rank, i.maxRank = n.node(i.borderBottom).rank, e = E(e, i.maxRank));
  }), n.graph().maxRank = e;
}
function hi(n) {
  s(n.nodes(), function(e) {
...
function vi(n) {
  s(n.edges(), function(e) {
    ...
    r.points ? (o = r.points[0], a = r.points[r.points.length - 1]) : (r.points = [], o = t, a = i), r.points.unshift(dn(i, o)), r.points.push(dn(t, a));
  });
}
function pi(n) {
  s(n.edges(), function(e) {
...
function mi(n) {
  s(n.nodes(), function(e) {
    if (n.children(e).length) {
      var r = n.node(e), i = n.node(r.borderTop), t = n.node(r.borderBottom), o = n.node(A(r.borderLeft)), a = n.node(A(r.borderRight));
...
//# sourceMappingURL=layout-D-lzUWQE.mjs.map
