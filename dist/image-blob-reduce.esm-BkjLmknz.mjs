  ...
  (function(d) {
    ...
    return (/* @__PURE__ */ function() {
      ...
      h.exports = function(c, r, t, e, i, a) {
        if (!(e === 0 || i < 0.5)) {
          i > 2 && (i = 2);
          var n = r * t, s = n * 4, f = n * 2, u = n * 2, l = Math.max(r, t) * 4, y = 8 * 4, m = 0, b = s, B = b + f, C = B + u, F = C + u, O = F + l, E = this.__instance("unsharp_mask", s + f + u * 2 + l + y, {
            exp: Math.exp
...
//# sourceMappingURL=image-blob-reduce.esm-BkjLmknz.mjs.map
