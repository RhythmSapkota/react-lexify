...
var pt = function() {
  var e = function(f1, a, o, f) {
    ...
    performAction: function(a, o, f, n, S, t, N1) {
      var s = t.length - 1;
      switch (S) {
        case 2:
          this.$ = [];
...
Expecting ` + Q1.join(", ") + ", got '" + (this.terminals_[G] || G) + "'" : ft = "Parse error on line " + (Y + 1) + ": Unexpected " + (G == jt ? "end of input" : "'" + (this.terminals_[G] || G) + "'"), this.parseError(ft, {
    ...
    var f1 = {
      ...
      unput: function(a) {
        ...
        }, this.options.ranges && (this.yylloc.range = [S[0], S[0] + this.yyleng - o]), this.yyleng = this.yytext.length, this;
      },
...
` + o + "^";
      ...
      test_match: function(a, o) {
        ...
        }, this.options.ranges && (S.yylloc.range = this.yylloc.range.slice(0))), n = a[0].match(/(?:\r\n?|\n).*/g), n && (this.yylineno += n.length), this.yylloc = {
      ...
      next: function() {
        ...
        for (var S = this._currentRules(), t = 0; t < S.length; t++)
          if (f = this._input.match(this.rules[S[t]]), f && (!o || f[0].length > o[0].length)) {
        ...
        return o ? (a = this.test_match(o, S[n]), a !== !1 ? a : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: function(o, f, n, S) {
        switch (n) {
          case 0:
...
//# sourceMappingURL=flowDb-956e92f1-IuDVc1Ax.mjs.map
