import { ay as y, aH as Ze, aI as qe, ax as Te, aJ as Qe, aK as Ee, aL as G, av as Q, aM as Xe, aN as Oe, aO as Je, aP as C, aE as me, aQ as x, aR as We, aS as Z, aT as ze, aU as Ve, aV as $, aD as ke, aW as en, aw as nn, aX as re, aY as rn, aZ as tn, aC as sn, aB as ve, az as an, a_ as B, at as un, a$ as fn, aF as N, ac as te, b0 as ie } from "./index-BXM0AnV6.mjs";
import { aO as X, aQ as O, aR as D, aP as we } from "./index-ErFAu9zp.mjs";
function Pe(e, n) {
  for (var r = -1, t = e == null ? 0 : e.length, i = Array(t); ++r < t; )
    i[r] = n(e[r], r, e);
  return i;
}
var se = O ? O.prototype : void 0, ae = se ? se.toString : void 0;
function Le(e) {
  if (typeof e == "string")
    return e;
  if (y(e))
...
var An = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Tn = /\\(\\)?/g, En = yn(function(e) {
  var n = [];
  return e.charCodeAt(0) === 46 && n.push(""), e.replace(An, function(r, t, i, s) {
    n.push(i ? s.replace(Tn, "$1") : t || r);
  }), n;
});
function On(e) {
  return e == null ? "" : Le(e);
...
var Cn = Object.prototype, In = Cn.propertyIsEnumerable, fe = Object.getOwnPropertySymbols, z = fe ? function(e) {
...
var Fn = Object.getOwnPropertySymbols, Ne = Fn ? function(e) {
  for (var n = []; e; )
    W(n, z(e)), e = Xe(e);
  return n;
} : Fe;
...
var Mn = Object.prototype, xn = Mn.hasOwnProperty;
function Dn(e) {
...
var Kn = "[object Boolean]", Hn = "[object Date]", Yn = "[object Map]", Zn = "[object Number]", qn = "[object RegExp]", Qn = "[object Set]", Xn = "[object String]", Jn = "[object Symbol]", Wn = "[object ArrayBuffer]", zn = "[object DataView]", Vn = "[object Float32Array]", kn = "[object Float64Array]", er = "[object Int8Array]", nr = "[object Int16Array]", rr = "[object Int32Array]", tr = "[object Uint8Array]", ir = "[object Uint8ClampedArray]", sr = "[object Uint16Array]", ar = "[object Uint32Array]";
function ur(e, n, r) {
  var t = e.constructor;
  switch (n) {
    case Wn:
...
var he = x && x.isMap, dr = he ? me(he) : or, hr = "[object Set]";
function lr(e) {
  return D(e) && C(e) == hr;
}
var le = x && x.isSet, gr = le ? me(le) : lr, cr = 1, _r = 2, pr = 4, Me = "[object Arguments]", br = "[object Array]", yr = "[object Boolean]", Ar = "[object Date]", Tr = "[object Error]", xe = "[object Function]", Er = "[object GeneratorFunction]", Or = "[object Map]", mr = "[object Number]", De = "[object Object]", vr = "[object RegExp]", wr = "[object Set]", Pr = "[object String]", Lr = "[object Symbol]", $r = "[object WeakMap]", Cr = "[object ArrayBuffer]", Ir = "[object DataView]", Sr = "[object Float32Array]", Fr = "[object Float64Array]", Nr = "[object Int8Array]", Rr = "[object Int16Array]", Mr = "[object Int32Array]", xr = "[object Uint8Array]", Dr = "[object Uint8ClampedArray]", Gr = "[object Uint16Array]", Ur = "[object Uint32Array]", d = {};
d[Me] = d[br] = d[Cr] = d[Ir] = d[yr] = d[Ar] = d[Sr] = d[Fr] = d[Nr] = d[Rr] = d[Mr] = d[Or] = d[mr] = d[De] = d[vr] = d[wr] = d[Pr] = d[Lr] = d[xr] = d[Dr] = d[Gr] = d[Ur] = !0;
d[Tr] = d[xe] = d[$r] = !1;
function j(e, n, r, t, i, s) {
  ...
  if (l) {
    ...
    var o = C(e), h = o == xe || o == Er;
    if (Z(e))
      return ze(e, u);
    if (o == De || o == Me || h && !i) {
      if (a = f || h ? {} : Ve(e), !u)
        return f ? Nn(e, $n(a, e)) : Sn(e, Ln(a, e));
    } else {
      if (!d[o])
        return i ? e : {};
      a = ur(e, o, u);
  ...
  var p = g ? f ? Rn : q : f ? Q : T, b = l ? void 0 : p(e);
  return $e(b || e, function(c, _) {
    b && (_ = c, c = e[_]), ke(a, _, j(c, n, r, _, e, s));
  }), a;
}
...
I.prototype.add = I.prototype.push = jr;
I.prototype.has = Kr;
function Hr(e, n) {
...
function Ue(e, n, r, t, i, s) {
  ...
  for (s.set(e, n), s.set(n, e); ++o < u; ) {
    ...
    if (A) {
      if (!Hr(n, function(_, m) {
        if (!Ge(A, m) && (p === _ || i(p, _, r, t, s)))
          return A.push(m);
      })) {
        h = !1;
        break;
...
var Qr = 1, Xr = 2, Jr = "[object Boolean]", Wr = "[object Date]", zr = "[object Error]", Vr = "[object Map]", kr = "[object Number]", et = "[object RegExp]", nt = "[object Set]", rt = "[object String]", tt = "[object Symbol]", it = "[object ArrayBuffer]", st = "[object DataView]", ge = O ? O.prototype : void 0, K = ge ? ge.valueOf : void 0;
...
function dt(e, n, r, t, i, s) {
  var a = r & ut, u = q(e), f = u.length, g = q(n), l = g.length;
  if (f != l && !a)
    return !1;
  for (var o = f; o--; ) {
    var h = u[o];
  ...
  for (var c = a; ++o < f; ) {
    ...
    var _ = e[h], m = n[h];
    if (t)
      var ne = a ? t(m, _, h, n, e, s) : t(_, m, h, e, n, s);
    if (!(ne === void 0 ? _ === m || i(_, m, r, t, s) : ne)) {
      b = !1;
      break;
    }
    c || (c = h == "constructor");
  ...
  if (b && !c) {
    var S = e.constructor, F = n.constructor;
    S != F && "constructor" in e && "constructor" in n && !(typeof S == "function" && S instanceof S && typeof F == "function" && F instanceof F) && (b = !1);
  }
  return s.delete(e), s.delete(n), b;
}
var ht = 1, ce = "[object Arguments]", _e = "[object Array]", R = "[object Object]", lt = Object.prototype, pe = lt.hasOwnProperty;
function gt(e, n, r, t, i, s) {
  var a = y(e), u = y(n), f = a ? _e : C(e), g = u ? _e : C(n);
  f = f == ce ? R : f, g = g == ce ? R : g;
  var l = f == R, o = g == R, h = f == g;
  if (h && Z(e)) {
    if (!Z(n))
      return !1;
    a = !0, l = !1;
  ...
  if (h && !l)
    return s || (s = new $()), a || rn(e) ? Ue(e, n, r, t, i, s) : at(e, n, f, r, t, i, s);
  if (!(r & ht)) {
  ...
  return h ? (s || (s = new $()), dt(e, n, r, t, i, s)) : !1;
}
function k(e, n, r, t, i) {
  return e === n ? !0 : e == null || n == null || !D(e) && !D(n) ? e !== e && n !== n : gt(e, n, r, t, k, i);
}
var ct = 1, _t = 2;
function pt(e, n, r, t) {
  var i = r.length, s = i;
...
function yt(e) {
  var n = bt(e);
  return n.length == 1 && n[0][2] ? je(n[0][0], n[0][1]) : function(r) {
    return r === e || pt(r, e, n);
  };
}
function At(e, n) {
...
function Ke(e, n, r) {
  ...
  return s || ++t != i ? s : (i = e == null ? 0 : e.length, !!i && tn(i) && sn(a, i) && (y(e) || Ee(e)));
}
function Tt(e, n) {
  return e != null && Ke(e, n, At);
}
var Et = 1, Ot = 2;
function mt(e, n) {
  return J(e) && Be(n) ? je(U(e), n) : function(r) {
    var t = mn(r, e);
    return t === void 0 && t === n ? Tt(r, e) : k(n, t, Et | Ot);
  };
}
function vt(e) {
  return function(n) {
...
function Pt(e) {
  return J(e) ? vt(U(e)) : wt(e);
}
function He(e) {
  return typeof e == "function" ? e : e == null ? ve : typeof e == "object" ? y(e) ? mt(e[0], e[1]) : yt(e) : Pt(e);
}
function Lt(e, n) {
  return e && an(e, n, T);
}
...
var St = Object.prototype, Ft = St.hasOwnProperty;
function Nt(e, n) {
  return e != null && Ft.call(e, n);
}
function E(e, n) {
  return e != null && Ke(e, n, Nt);
}
function Rt(e, n) {
...
function H(e) {
  return e == null ? [] : Rt(e, T(e));
}
function P(e) {
  return e === void 0;
}
function Mt(e, n, r, t, i) {
  return i(e, function(s, a, u) {
    r = t ? (t = !1, s) : n(r, s, a, u);
  }), r;
}
function xt(e, n, r) {
  var t = y(e) ? Pn : Mt, i = arguments.length < 3;
  return t(e, He(n), r, i, ee);
}
var Dt = 1 / 0, Gt = B && 1 / V(new B([, -0]))[1] == Dt ? function(e) {
  return new B(e);
} : on, Ut = 200;
function Bt(e, n, r) {
...
var jt = un(function(e) {
  return Bt(wn(e, 1, fn, !0));
}), Kt = "\0", w = "\0", be = "";
class Ye {
  constructor(n = {}) {
  ...
  setDefaultNodeLabel(n) {
    return te(n) || (n = N(n)), this._defaultNodeLabelFn = n, this;
  }
  nodeCount() {
  ...
  setDefaultEdgeLabel(n) {
    return te(n) || (n = N(n)), this._defaultEdgeLabelFn = n, this;
  }
  edgeCount() {
  ...
  setEdge() {
    ...
    var f = Ht(this._isDirected, n, r, t);
...
//# sourceMappingURL=graph-BCqGxtUq.mjs.map
