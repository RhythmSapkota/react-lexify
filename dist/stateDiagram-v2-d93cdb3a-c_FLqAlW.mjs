import { s as Q, d as B, p as X, D as Z, a as H, b as m, S as F, c as I } from "./styles-6aaf32cf-JSI_1oJf.mjs";
import { G as tt } from "./graph-BCqGxtUq.mjs";
import { l as E, g, d as x, u as et, e as ot, j as w } from "./index-BXM0AnV6.mjs";
import { r as st } from "./index-3862675e-jHCCrE1r.mjs";
import "./index-ErFAu9zp.mjs";
import "./layout-D-lzUWQE.mjs";
...
const A = (t, n, e, c, i, r) => {
  ...
  if (o !== "root") {
    ...
    const s = y[o];
    e.description && (Array.isArray(s.description) ? (s.shape = C, s.description.push(e.description)) : s.description.length > 0 ? (s.shape = C, s.description === o ? s.description = [e.description] : s.description = [s.description, e.description]) : (s.shape = h, s.description = e.description), s.description = w.sanitizeTextOrArray(s.description, g())), s.description.length === 1 && s.shape === C && (s.shape = h), !s.type && e.doc && (E.info("Setting cluster for ", o, G(e)), s.type = "group", s.dir = G(e), s.shape = e.type === m ? it : rt, s.classes = s.classes + " " + Dt + " " + (r ? ft : ""));
    const p = {
      labelStyle: "",
      shape: s.shape,
  ...
  let p;
  i === "sandbox" && (p = x("#i" + n));
  const l = i === "sandbox" ? x(p.nodes()[0].contentDocument.body) : x("body"), a = l.select(`[id="${n}"]`), D = l.select("#" + n + " g");
...
//# sourceMappingURL=stateDiagram-v2-d93cdb3a-c_FLqAlW.mjs.map
