import { aq as X } from "./index-ErFAu9zp.mjs";
import { c as T } from "./_commonjs-dynamic-modules-BpilXLfW.mjs";
function q(H, Y) {
  ...
  (function(d) {
    ...
    return (/* @__PURE__ */ function() {
      ...
      I.exports = function(o, A, n, a, t, e) {
        if (!(a === 0 || t < 0.5)) {
          t > 2 && (t = 2);
          var i = A * n, h = i * 4, c = i * 2, f = i * 2, _ = Math.max(A, n) * 4, p = 8 * 4, m = 0, w = h, B = w + c, y = B + f, E = y + f, R = E + _, b = this.__instance("unsharp_mask", h + c + f * 2 + _ + p, {
            exp: Math.exp
...
var z = W.exports;
const N = /* @__PURE__ */ X(z), V = /* @__PURE__ */ q({
  __proto__: null,
  default: N
}, [z]);
export {
...
//# sourceMappingURL=pica-Dp1VwcZy.mjs.map
