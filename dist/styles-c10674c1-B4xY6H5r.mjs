import { G as M } from "./graph-BCqGxtUq.mjs";
import { a8 as R, ab as F, ac as j, a6 as U, l as h, g as S, d as $, u as H, Y as K, _ as A, $ as E, a0 as L, V as G, j as z, t as W } from "./index-BXM0AnV6.mjs";
import { r as X } from "./index-3862675e-jHCCrE1r.mjs";
import { c as Y } from "./channel-C5NvdyGW.mjs";
function J(e) {
...
`), S()), n.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + y + " " + w, l.setEdge(n.start, n.end, t, a);
  ...
  let r;
  d === "sandbox" && (r = $("#i" + l));
  const y = d === "sandbox" ? $(r.nodes()[0].contentDocument.body) : $("body"), w = d === "sandbox" ? r.nodes()[0].contentDocument : document, t = new M({
    multigraph: !0,
    compound: !0
  }).setGraph({
    rankdir: i,
...
//# sourceMappingURL=styles-c10674c1-B4xY6H5r.mjs.map
