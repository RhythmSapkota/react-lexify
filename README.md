      ...
      plugins={{
        ...
        mentions: {
          ...
          fetchMentions: async (query) => {
            ...
            return [
              { id: '1', displayName: 'John Doe', meta: { name: 'John', email: 'john@example.com', imageUrl: '/john.jpg' } },
              { id: '2', displayName: 'Jane Smith', meta: { name: 'Jane', email: 'jane@example.com', imageUrl: '/jane.jpg' } }
            ].filter(user => 
